      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn direction="up">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold font-heading mb-4 text-textColor">Standardized Documentation</h2>
            <p className="text-xl text-gray-500">See how the platform helps create high-quality, compliant documents.</p>
          </div>
        </FadeIn>
